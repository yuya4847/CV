...
- 雇用形態: 正社員
- メモ: 新卒で入社した会社で、2つほど、携わらせていただいたプロジェクトに関する概要と詳細を記載しています。

### プロジェクト名: ClinPeer(専門医のための臨床研鑽アプリ)

プロジェクト概要: 最新論文(英語)の要点や翻訳を行い、論文解説や症例検討を通じてエキスパートの視点を深く学べるスマホアプリ(一部Web)のサーバーサイド開発
...
プロジェクト概要: 日本の医師・医学生を対象とした会員制の医療情報プラットフォームのサーバーサイド開発
